...
def _prepare_examples_for_inference(
    ...
    return prompts, example_ids, dihedral_ids, metadata
...
def run_split_inference(
    ...
    for start in range(0, len(work_items), batch_size):
        ...
        if augmentor is None:
            prompts, example_ids, dihedral_ids, metadata = _prepare_examples_for_inference(batch_examples)
        else:
            prompts, example_ids, dihedral_ids, metadata = _prepare_examples_for_inference(
                batch_examples,
